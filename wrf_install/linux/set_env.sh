...
# @Last Modified time: 2019-01-02 18:47:52
...
# Setting library versions for usage (last checked: 2019-01-02)
export WRF_VERSION="3.8.1"            # latest: 4.0.2
export WPS_VERSION="3.8.1"            # latest: 4.0.2
