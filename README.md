...
## Software components (last query: 2026-08-02)
...
### Selfcompiled
* WRF model: [Source](https://github.com/wrf-model/WRF/releases), used version: 4.7.1; newest: 4.8.0
* WPS component: [Source](https://github.com/wrf-model/WPS/releases), used version: 4.6; newest: 4.7
* Noah-MP Community Model Repository: [Source](https://github.com/NCAR/noahmp), used branch v4.7-WRF: ; newest release: 5.2.1
* Network Common Data Form (NetCDF): [Source](https://github.com/Unidata/netcdf-c/releases) and [Terms of use](https://www2.ucar.edu/terms-of-use), used version: 4.9.3; newest: 4.10.1
* Hierarchical Data Format 5 (HDF5): [Source](https://github.com/HDFGroup/hdf5/) and [Terms of use](https://github.com/HDFGroup/hdf5/blob/develop/COPYING) used version: 1.14.6; newest: 2.2.0
* NetCDF-Fortran Library: [Source](https://github.com/Unidata/netcdf-fortran/releases) and [Terms of use](https://www2.ucar.edu/terms-of-use), used version: 4.6.2; newest: 4.6.4
* Message Passing Interface (mpich): [Source](https://www.mpich.org/) and [License](http://git.mpich.org/mpich.git/blob/HEAD:/COPYRIGHT), used version: 4.3.0; newest: 5.0.1

### ArchLinux Packages
* PNG reference library (libpng): [Source](http://www.libpng.org/pub/png/libpng.html) and [License](http://www.libpng.org/pub/png/src/libpng-LICENSE.txt), used version: ArchLinux package; newest: 1.6.58
...
* tested setups:
  ...
  - WRF Model v4.4.0 and WPS v4.4 [compiling, normal_build, running]
    - NetCDF v4.8.1 / NetCDF-Fortran Library v4.5.4, HDF 1.13.0 mpi 4.1.2
    - libpng, zlib, JasPer as ArchLinux packages
    - gcc/gfortran: 12.1
  - WRF Model v4.5.0 and WPS v4.5 [compiling, normal_build, running]
    - NetCDF v4.9.2 / NetCDF-Fortran Library v4.6.1, HDF 1.14.1, mpi 4.1.2
    - libpng, zlib, JasPer as ArchLinux packages
    - gcc/gfortran: 13.1.1    
