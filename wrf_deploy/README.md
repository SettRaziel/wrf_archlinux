...
latest version of WRFV4 (currently: 4.6.1) and the minimal geodata (~200 mb) 
required to start a model run. The main script will be extended to accept
parameters to customize the deployment process.

## Parameters
* WRF version, currently available for deployment: 4.4.0, 4.5.0, 4.6.1, 4.7.1, 4.8.0
* older versions that need manual deployment or older wrf_archlinux versions: 3.8.0, 3.9.0, 3.9.1, 4.0.2, 4.1.5, 4.2.0
* Geodata: 
