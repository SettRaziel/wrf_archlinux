...
case ${WRF_VERSION_INDEX} in
  [1]* ) FILE_NAME='wrf_440'; WRF_FOLDER='WRF-4.4'; WPS_FOLDER='WPS-4.4';;
  [2]* ) FILE_NAME='wrf_420'; WRF_FOLDER='WRF-4.2'; WPS_FOLDER='WPS-4.2';;
  [3]* ) FILE_NAME='wrf_410'; WRF_FOLDER='WRF-4.1.5'; WPS_FOLDER='WPS-4.1';;
  [4]* ) FILE_NAME='wrf_400'; WRF_FOLDER='WRF'; WPS_FOLDER='WPS';;
esac
...
case ${WRF_GEODATA_INDEX} in
    [1]* ) cp ../additions/config/namelist.wps "${HOME}/${FILE_NAME}/${WPS_FOLDER}";;
    [2]* ) cp ../additions/config/namelist_low_res.wps "${HOME}/${FILE_NAME}/${WPS_FOLDER}/namelist.wps";;
esac
