...
# @Last Modified time: 2019-06-14 18:23:50
...
for i in $(seq -f %03g 0 3 ${5}); do
  ...
  while [ $tries -gt 0 ] 
  do
    curl -C - -o ${3}/gfs.t${2}z.pgrb2.${4}.f${i} https://para.nomads.ncep.noaa.gov/pub/data/nccf/com/gfs/para/gfs.${1}${2}/gfs.t${2}z.pgrb2.${4}.f${i}
    if [ $? -ne 56 ]
     then break
    fi
    let --tries
